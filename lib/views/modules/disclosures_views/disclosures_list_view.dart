                ...
                child: Consumer<DisclosurePageProvider>(
                    builder: (context, provider, child) {
                      if (provider.disclosuresData?.disclosures == null) {
                        provider.getListOfDisclosures(context);
    ...
    child: Row(
      children: [
        Container(
            ...
            color: Colors.red,
            child: CustomText(
                text: AppLocalizations.of(context)!.disclosure_list,
                color: Colors.white,
                fontSize: 20,
                fontWeight: FontWeight.bold)),
        const SizedBox(
              ...
              child: DropdownStringList(
                boxDecoration: Colors.white,
                  ...
                  onChanged: (String? newValue) async {
                    ...
                    DisclosurePageProvider providerGetDisclosureByDateYear = Provider.of<DisclosurePageProvider>(context,listen: false);
                    Future.delayed(Duration.zero, () {providerGetDisclosureByDateYear.getListOfDisclosures(data);});
                  }, color:  Colors.black,)),
        ),
      ],
    ),
