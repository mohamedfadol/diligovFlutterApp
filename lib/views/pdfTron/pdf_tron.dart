...
// class PdfTron extends StatefulWidget {
//   final String filePathUrl;
//   const PdfTron({Key? key, required this.filePathUrl}) : super(key: key);
//   static const routeName = '/PdfTron';
//   @override
//   State<PdfTron> createState() => _PdfTronState();
// }

// class _PdfTronState extends State<PdfTron> {
//   String _version = 'Unknown';
//   // String _document =
//       // "https://diligov.com/public/charters/1/1673837657.A-Z-Alphabet-Book-and-1-10.pdf";
...
//     await PdftronFlutter.openDocument(widget.filePathUrl);
...
//     await PdftronFlutter.openDocument(widget.filePathUrl, config: config);
...
//     controller.openDocument(widget.filePathUrl, config: config);
//   }
