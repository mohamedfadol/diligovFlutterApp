...
class QuickAccessMemberListView extends StatefulWidget {
  const QuickAccessMemberListView({Key? key}) : super(key: key);
  static const routeName = '/QuickAccessMemberListView';

  @override
  State<QuickAccessMemberListView> createState() => _QuickAccessMemberListViewState();
}

class _QuickAccessMemberListViewState extends State<QuickAccessMemberListView>   with InputValidationMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // backgroundColor: Colour().mainContentColor,
                ...
                builder: (context,  provider, child){
                  ...
                  return SingleChildScrollView(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        // border: const TableBorder(horizontalInside: BorderSide(color: Colors.black,width: 2.0),verticalInside: BorderSide(color: Colors.black,width: 2.0)),
